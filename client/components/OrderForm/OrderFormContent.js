...
function getStepContent (step, control, buyerType, setBuyerType) {
            ...
            return (
                <Controller
                    ...
                    render={({ field: { onChange } }) => (
                        <SelectPurchaseForm>
                            <StepperCard Icon={BusinessIcon} title="Firma" value="company" onChange={onChange} name="orderType"
                        ...
                        <SelectPurchaseForm>
                            ...
                            {data && data.map(product => (
                                    <StepperCard key={product.product_id} Icon={SaveIcon} title={product.name} value={product.product_id}
                                                 ...
                                                 selectedValue={buyerType} setSelectedValue={setBuyerType} isActive={product.active} price={product.price}/>
